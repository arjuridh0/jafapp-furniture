...
<section class="relative py-20 bg-sand-900 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/6285163520603" target="_blank" class="group inline-flex items-center gap-3 bg-forest-700 hover:bg-forest-600 text-white font-semibold py-4 px-8 rounded-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
